...
class TopsCategory extends StatelessWidget {
  const TopsCategory({super.key});
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Container(child: grid("Shirts", phoneWidth, phoneHeight)),
            const Padding(
              padding: EdgeInsets.only(left: 10, top: 15, bottom: 8),
              child: Text(
                "Jackets",
            ...
            Container(child: grid("Jackets", phoneWidth, phoneHeight)),
          ],
        ),
      ),
    );
